...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rubyforge>.freeze, [">= 2.0.3".freeze])
  s.add_development_dependency(%q<gemcutter>.freeze, [">= 0.2.1".freeze])
  s.add_development_dependency(%q<hoe>.freeze, [">= 2.5.0".freeze])
end
